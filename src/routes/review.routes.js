...
router.get('/product/:productId', async (req, res) => {
  try {
    ...
    const reviews = rows.map(r => ({ id: r.id, userId: r.userId, productId: r.productId, rating: r.rating, title: r.title, body: r.body, images: r.images ? safeParseJSON(r.images) : null, isApproved: r.isApproved, helpfulCount: r.helpfulCount, notHelpfulCount: r.notHelpfulCount, createdAt: r.createdAt, user: { name: r.user_name } }));
